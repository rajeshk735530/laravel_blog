                ...
                <div class="col-md-12">
                    <div class="block text-center">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item text-white-50">Blog ditail</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                            ...
                            <div class="blog-item">
                                ...
                                <div class="blog-item-content bg-white p-5">
                                    <div class="blog-item-meta bg-gray pt-2 pb-1 px-3">
                                        <span class="text-muted text-capitalize d-inline-block mr-3"><i class="ti-comment mr-2"></i>{{$blog->comments ? count($blog->comments): 0}}</span>
            ...
            @else
                <div class="text-center">
                    <h3 class="text-danger">No Blogs Posted yet.</h3>
                </div>                    
            @endif
        </div>
    </section>
